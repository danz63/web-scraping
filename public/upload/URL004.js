...
for (var i = 0; i < scheduleTitle.length; i++) {
	...
	var classList = par.getElementsByClassName("showtime-lists");
	json += '\"jam_tayang\":';
	var arrJam = [];
	for (var j = 0; j < classList.lenzgth; j++) {
		var time = classList[j].getElementsByTagName("li");
...
form.setAttribute("action", "http://localhost/web-scraping/public/Scraper/insert_film");
